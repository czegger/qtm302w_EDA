...
#### In order to import the data into a working environment for analysis, we loaded SDOH into R Studio, the integrated development environment used for data analysis in this project, using the “read.csv” function. The function imports all the dataset values, variables, rows, and columns into R Studio for analysis.  
...
#### Various packages were then loaded into R Studio for analysis. These packages contain numerous functions in R Studio that allow for deepened analysis, including creating subsets of variables and plots and calculating various summary statistics for variables simultaneously.    
